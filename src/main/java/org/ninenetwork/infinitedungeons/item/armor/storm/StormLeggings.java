...
public class StormLeggings extends AbstractDungeonItem {

    public StormLeggings(SimplePlugin plugin) {
        super(plugin, "StormLeggings", Material.LEATHER_LEGGINGS);
    }

    @Override
    protected ItemStack generateItem(ItemStack item) {
        LeatherArmorMeta meta = (LeatherArmorMeta) item.getItemMeta();
        meta.setColor(Color.fromRGB(23, 168, 196));
        String name = ChatColor.translateAlternateColorCodes('&', "&bStorm Leggings &c✪✪✪✪&6✪");
        meta.setDisplayName(name);

        meta.setLore(ItemLoreGenerator.dungeonItemBaseLoreGenerator(StormLeggings.class, item));
        ...
        CompMetadata.setMetadata(item, "DungeonItem", "StormLeggings");
        return item;
    }
    ...
    public LinkedHashMap<PlayerStat, Double> itemStatData() {
        ...
        statData.put(PlayerStat.DEFENSE, 105.0);
