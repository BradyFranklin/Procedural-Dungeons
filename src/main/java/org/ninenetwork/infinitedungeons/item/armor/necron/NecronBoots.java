...
public class NecronBoots extends AbstractDungeonItem {

    public NecronBoots(SimplePlugin plugin) {
        super(plugin, "NecronBoots", Material.LEATHER_BOOTS);
    }
    ...
    protected ItemStack generateItem(ItemStack item) {
        ...
        String name = ChatColor.translateAlternateColorCodes('&', "&dNecron's Boots");
        meta.setDisplayName(name);

        meta.setLore(ItemLoreGenerator.dungeonItemBaseLoreGenerator(NecronBoots.class, item));
        ...
        CompMetadata.setMetadata(item, "DungeonItem", "NecronBoots");
        return item;
    }
    ...
    public LinkedHashMap<PlayerStat, Double> itemStatData() {
        ...
        statData.put(PlayerStat.DEFENSE, 85.0);
