...
@Getter
public class SilentAssassinLeggings extends AbstractDungeonItem {

    public SilentAssassinLeggings(SimplePlugin plugin) {
        super(plugin, "SilentAssassinLeggings", Material.LEATHER_LEGGINGS);
    }
    ...
    protected ItemStack generateItem(ItemStack item) {
        ...
        String name = ChatColor.translateAlternateColorCodes('&', "&5Silent Assassin Leggings");
        meta.setDisplayName(name);

        meta.setLore(ItemLoreGenerator.dungeonItemBaseLoreGenerator(SilentAssassinLeggings.class, item));
        ...
        CompMetadata.setMetadata(item, "DungeonItem", "SilentAssassinLeggings");
        return item;
    }
    ...
    public LinkedHashMap<PlayerStat, Double> itemStatData() {
        ...
        statData.put(PlayerStat.HEALTH, 210.0);
        statData.put(PlayerStat.DEFENSE, 95.0);
    ...
    public String itemRarityDescription() {
        return "&5&l&k% &5&lEPIC DUNGEON LEGGINGS &5&l&k%";
    }
