...
public class SilentAssassinChestplate extends AbstractDungeonItem {

    public SilentAssassinChestplate(SimplePlugin plugin) {
        super(plugin, "SilentAssassinChestplate", Material.LEATHER_CHESTPLATE);
    }
    ...
    protected ItemStack generateItem(ItemStack item) {
        ...
        String name = ChatColor.translateAlternateColorCodes('&', "&5Silent Assassin Chestplate");
        meta.setDisplayName(name);

        meta.setLore(ItemLoreGenerator.dungeonItemBaseLoreGenerator(SilentAssassinChestplate.class, item));
        ...
        CompMetadata.setMetadata(item, "DungeonItem", "SilentAssassinChestplate");
        return item;
    }
    ...
    public LinkedHashMap<PlayerStat, Double> itemStatData() {
        ...
        statData.put(PlayerStat.HEALTH, 240.0);
        statData.put(PlayerStat.DEFENSE, 110.0);
    ...
    public String itemRarityDescription() {
        return "&5&l&k% &5&lEPIC DUNGEON CHESTPLATE &5&l&k%";
    }
