...
public class DungeonLobbyDoor {
    ...
    private final Region doorRegion;
    ...
    protected DungeonLobbyDoor(Region region, File schematic) {
    ...
    public void addToFallBlocks(Block block) {
        ArrayList<Block> blocks = this.fallBlocks;
        blocks.add(block);
        setFallBlocks(blocks);
    }
    ...
    public static void addLobbyDungeonDoor(Dungeon dungeon, DungeonRoomPoint point, DungeonRoomPoint nextPoint) {
        if (!Objects.equals(DungeonRoomInstance.getRoomFromPoint(dungeon, point), DungeonRoomInstance.getRoomFromPoint(dungeon, nextPoint))) {
            ...
            File schematic = FileUtil.getFile("DungeonStorage/Schematics/lobbydoor.schematic");
            DungeonLobbyDoor dungeonDoor = new DungeonLobbyDoor(region, schematic);
            ...
            dungeon.setLobbyDoor(dungeonDoor);
        } else {
