...
public class NMSFossilizedTarantula extends CaveSpider {

    public NMSFossilizedTarantula(Location loc) {
        ...
        this.getBukkitEntity().setMetadata("FossilizedTarantula", new FixedMetadataValue(InfiniteDungeonsPlugin.getInstance(), true));
