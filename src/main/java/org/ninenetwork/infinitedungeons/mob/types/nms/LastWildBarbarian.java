...
public class LastWildBarbarian extends Zombie {

    public LastWildBarbarian(Location loc) {
        ...
        this.getBukkitEntity().setMetadata("WildBarbarian", new FixedMetadataValue(InfiniteDungeonsPlugin.getInstance(), true));
