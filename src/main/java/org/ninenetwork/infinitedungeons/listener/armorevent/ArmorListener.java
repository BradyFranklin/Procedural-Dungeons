...
public class ArmorListener implements Listener {
    ...
    public void onInteract(PlayerInteractEvent event){
        ...
        if(event.getAction() == Action.RIGHT_CLICK_AIR || event.getAction() == Action.RIGHT_CLICK_BLOCK){
            ...
            if(newArmorType != null){
                if(newArmorType.equals(ArmorType.HELMET) && isEmpty(event.getPlayer().getInventory().getHelmet()) && event.getItem().getType() != Material.PLAYER_HEAD || newArmorType.equals(ArmorType.CHESTPLATE) && isEmpty(event.getPlayer().getInventory().getChestplate()) && event.getItem().getType() != Material.PLAYER_HEAD || newArmorType.equals(ArmorType.LEGGINGS) && isEmpty(event.getPlayer().getInventory().getLeggings()) && event.getItem().getType() != Material.PLAYER_HEAD || newArmorType.equals(ArmorType.BOOTS) && isEmpty(event.getPlayer().getInventory().getBoots()) && event.getItem().getType() != Material.PLAYER_HEAD){
